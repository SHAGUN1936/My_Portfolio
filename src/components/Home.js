...
const Home = () => (
  <section id="home" className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-gray-800 dark:to-gray-900">
    ...
    <a href="https://drive.google.com/file/d/1khgtnnKoUrGcvsAOYV0uK4aEV5h_hY1D/view?usp=sharing" download className="mt-6 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">
      Download Resume
    </a>
  </section>
);
